...
Содержание
----------
- [Как зарегистрироваться на urban3p.ru](#urban_registry)
- [Карта Сьян](#syan)
...
7. Для получения статуса "pro" и возможности просматривать координаты необходимо ~17 кармы, 700+ рейтинга и добавление, как минимум, одного объекта, которого нет в базе. 1 фотография даёт 5 рейтинга, один объект - 50 рейтинга. Для получения кармы необходимо продолжать писать отчёты.
